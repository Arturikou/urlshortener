...
func (x *URLShortenRequest) Reset() {
	*x = URLShortenRequest{}
	mi := &file_api_proto_shortener_v1_shortener_proto_msgTypes[0]
...
func (x *URLShortenResponse) Reset() {
	*x = URLShortenResponse{}
	mi := &file_api_proto_shortener_v1_shortener_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLExpandRequest) Reset() {
	*x = URLExpandRequest{}
	mi := &file_api_proto_shortener_v1_shortener_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLExpandResponse) Reset() {
	*x = URLExpandResponse{}
	mi := &file_api_proto_shortener_v1_shortener_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *UserURLsResponse) Reset() {
	*x = UserURLsResponse{}
	mi := &file_api_proto_shortener_v1_shortener_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *URLData) Reset() {
	*x = URLData{}
	mi := &file_api_proto_shortener_v1_shortener_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_api_proto_shortener_v1_shortener_proto protoreflect.FileDescriptor

const file_api_proto_shortener_v1_shortener_proto_rawDesc = "" +
	"\n" +
	"&api/proto/shortener/v1/shortener.proto\x12\x02v1\x1a\x1bgoogle/protobuf/empty.proto\x1a!google/protobuf/go_features.proto\"%\n" +
	...
	"\x10UserURLsResponse\x12\x1d\n" +
	"\x03url\x18\x01 \x03(\v2\v.v1.URLDataR\x03url\"I\n" +
	"\aURLData\x12\x1b\n" +
	"\tshort_url\x18\x01 \x01(\tR\bshortUrl\x12!\n" +
	"\foriginal_url\x18\x02 \x01(\tR\voriginalUrl2\xc7\x01\n" +
	"\x10ShortenerService\x12;\n" +
	"\n" +
	"ShortenURL\x12\x15.v1.URLShortenRequest\x1a\x16.v1.URLShortenResponse\x128\n" +
	"\tExpandURL\x12\x14.v1.URLExpandRequest\x1a\x15.v1.URLExpandResponse\x12<\n" +
	"\fListUserURLs\x12\x16.google.protobuf.Empty\x1a\x14.v1.UserURLsResponseBEZ;github.com/Arturikou/urlshortener/api/proto/shortener/v1;pb\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_api_proto_shortener_v1_shortener_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_api_proto_shortener_v1_shortener_proto_goTypes = []any{
	(*URLShortenRequest)(nil),  // 0: v1.URLShortenRequest
	(*URLShortenResponse)(nil), // 1: v1.URLShortenResponse
	(*URLExpandRequest)(nil),   // 2: v1.URLExpandRequest
	(*URLExpandResponse)(nil),  // 3: v1.URLExpandResponse
	(*UserURLsResponse)(nil),   // 4: v1.UserURLsResponse
	(*URLData)(nil),            // 5: v1.URLData
	(*emptypb.Empty)(nil),      // 6: google.protobuf.Empty
}
var file_api_proto_shortener_v1_shortener_proto_depIdxs = []int32{
	5, // 0: v1.UserURLsResponse.url:type_name -> v1.URLData
	0, // 1: v1.ShortenerService.ShortenURL:input_type -> v1.URLShortenRequest
	2, // 2: v1.ShortenerService.ExpandURL:input_type -> v1.URLExpandRequest
	6, // 3: v1.ShortenerService.ListUserURLs:input_type -> google.protobuf.Empty
	1, // 4: v1.ShortenerService.ShortenURL:output_type -> v1.URLShortenResponse
	3, // 5: v1.ShortenerService.ExpandURL:output_type -> v1.URLExpandResponse
	4, // 6: v1.ShortenerService.ListUserURLs:output_type -> v1.UserURLsResponse
...
func init() { file_api_proto_shortener_v1_shortener_proto_init() }
func file_api_proto_shortener_v1_shortener_proto_init() {
	if File_api_proto_shortener_v1_shortener_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_proto_shortener_v1_shortener_proto_rawDesc), len(file_api_proto_shortener_v1_shortener_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_proto_shortener_v1_shortener_proto_goTypes,
		DependencyIndexes: file_api_proto_shortener_v1_shortener_proto_depIdxs,
		MessageInfos:      file_api_proto_shortener_v1_shortener_proto_msgTypes,
	}.Build()
	File_api_proto_shortener_v1_shortener_proto = out.File
	file_api_proto_shortener_v1_shortener_proto_goTypes = nil
	file_api_proto_shortener_v1_shortener_proto_depIdxs = nil
}
