    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.ShortenReq"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/handlers.ShortenResp"
                        }
                    },
                    "400": {
        ...
        "/api/shorten/batch": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Batch of URLs to shorten",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handlers.ShortenBatchReq"
                            }
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handlers.ShortenBatchResp"
                            }
                        }
                    },
                    "400": {
                        "description": "Bad request or empty batch",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/user/urls": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handlers.UserUrlsResp"
                            }
                        }
                    },
                    "204": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "List of aliases to delete",
                        "name": "aliases",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Bad request or empty list",
                        "schema": {
                            "type": "string"
                        }
                    },
